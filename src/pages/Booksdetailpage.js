		...
		<div className="row py-5">
			<div className="col-lg-8">
				...
				<ul className="list-inline mb-0">
					<li className="list-inline-item h6 me-3 mb-1 mb-sm-0"><i className="fas fa-star text-warning me-2"></i>4.5/5.0</li>
									...
									<div className="d-md-flex my-4">
										...
										<div>
											...
											<div className="btn-group" role="group" aria-label="Basic radio toggle button group">
												...
												<label className="btn btn-outline-light btn-sm mb-0" for="btnradio1"><i className="far fa-thumbs-up me-1"></i>25</label>
												{/* <!-- Dislike button --> */}
												<input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
												<label className="btn btn-outline-light btn-sm mb-0" for="btnradio2"> <i className="far fa-thumbs-down me-1"></i>2</label>
											</div>
										</div>
									</div>
									...
									<div className="d-md-flex my-4">
										...
										<div>
											...
											<div className="btn-group" role="group" aria-label="Basic radio toggle button group">
												...
												<label className="btn btn-outline-light btn-sm mb-0" for="btnradio3"><i className="far fa-thumbs-up me-1"></i>25</label>
												{/* <!-- Dislike button --> */}
												<input type="radio" className="btn-check" name="btnradio" id="btnradio4"/>
												<label className="btn btn-outline-light btn-sm mb-0" for="btnradio4"> <i className="far fa-thumbs-down me-1"></i>2</label>
											</div>
										</div>	
									</div>
									{/* <!-- Review item END --> */}
									...
									<div className="col-12">
										...
										<div className="d-flex mb-4">
											...
											<form className="w-100 d-flex">
												<textarea className="one form-control pe-4 bg-light" id="autoheighttextarea" rows="1" placeholder="Add a comment..."></textarea>
	...
	<div className="container">
		...
		<div className="row">
			...
			<div className="tiny-slider arrow-round arrow-blur arrow-hover">
				...
				<TinySlider className="tiny-slider-inner" settings={settings}>
					{topCourse.map((e) => (
						<div className="pb-4">
							<div className="card p-2 border">
								<div className="rounded-top overflow-hidden">
									<div className="card-overlay-hover">
										<img src={require("../assets/images/courses/4by3/17.jpg")} className="card-img-top" alt="course image"/>
									</div>
									{/* <!-- Hover element --> */}
