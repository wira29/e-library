				...
				<TinySlider className="tiny-slider-inner" settings={settings}>
					{topCourse.map((e) => (
						...
						<div class="card action-trigger-hover border bg-transparent">
							{/* <!-- Image --> */}
							<img src={require("../assets/images/courses/4by3/14.jpg")} class="card-img-top" alt="course image" />
							{/* <!-- Ribbon --> */}
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src={require("../assets/images/avatar/10.jpg")} alt="avatar" />
										</div>
