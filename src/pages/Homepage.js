				...
				<div className="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style={{background:'url(assets/images/pattern/01.png) no-repeat center center', backgroundSize:'cover'}}>
					...
					<ul className="avatar-group mb-0">
						<li className="avatar avatar-sm">
							<img className="avatar-img rounded-circle border-white" src={ require("../assets/images/avatar/01.jpg")} alt="avatar"/>
						</li>
						<li className="avatar avatar-sm">
							<img className="avatar-img rounded-circle border-white" src={require("../assets/images/avatar/02.jpg")} alt="avatar"/>
						</li>
						<li className="avatar avatar-sm">
							<img className="avatar-img rounded-circle border-white" src={require("../assets/images/avatar/03.jpg")} alt="avatar"/>
						</li>
						<li className="avatar avatar-sm">
							<img className="avatar-img rounded-circle border-white" src={require("../assets/images/avatar/04.jpg")} alt="avatar"/>
						</li>
						<li className="avatar avatar-sm">
						...
						<div className="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
							...
							<div className="d-flex align-items-center mb-3">
								...
								<div className="avatar avatar-sm">
									<img className="avatar-img rounded-1" src={require("../assets/images/avatar/09.jpg")} alt="avatar"/>
								</div>
								{/* <!-- Info --> */}
								<div className="ms-2">
							...
							<div className="d-flex align-items-center mb-3">
								{/* <!-- Avatar --> */}
								<div className="avatar avatar-sm">
									<img className="avatar-img rounded-1" src={require("../assets/images/avatar/04.jpg")} alt="avatar"/>
								</div>
								{/* <!-- Info --> */}
								<div className="ms-2">
							...
							<div className="d-flex align-items-center">
								{/* <!-- Avatar --> */}
								<div className="avatar avatar-sm">
									<img className="avatar-img rounded-1" src={require("../assets/images/avatar/02.jpg")} alt="avatar"/>
								</div>
								{/* <!-- Info --> */}
								<div className="ms-2">
