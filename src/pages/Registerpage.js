...
import bg2 from "../assets/images/element/03.svg"
					...
					<div class="p-3 p-lg-5">
						...
						<div class="d-sm-flex mt-5 align-items-center justify-content-center">
							<ul class="avatar-group mb-2 mb-sm-0">
								<li class="avatar avatar-sm"><img class="avatar-img rounded-circle" src={require("../assets/images/avatar/01.jpg")} alt="avatar"/></li>
								<li class="avatar avatar-sm"><img class="avatar-img rounded-circle" src={require("../assets/images/avatar/02.jpg")} alt="avatar"/></li>
								<li class="avatar avatar-sm"><img class="avatar-img rounded-circle" src={require("../assets/images/avatar/03.jpg")} alt="avatar"/></li>
								<li class="avatar avatar-sm"><img class="avatar-img rounded-circle" src={require("../assets/images/avatar/04.jpg")} alt="avatar"/></li>
							</ul>
							{/* <!-- Content --> */}
				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							{/* <!-- Title --> */}
							<img src={bg2} class="h-40px mb-2" alt="" />
